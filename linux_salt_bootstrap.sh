...
function install_salt_repo() {
  rpm --import https://repo.saltstack.com/yum/redhat/7/x86_64/2016.3/SALTSTACK-GPG-KEY.pub
  ...
  echo 'baseurl=https://repo.saltstack.com/yum/redhat/$releasever/$basearch/2016.3' >> $repofile
  echo 'enabled=1'  >> $repofile
  echo 'gpgcheck=1' >> $repofile
  echo 'gpgkey=https://repo.saltstack.com/yum/redhat/$releasever/$basearch/2016.3/$releaseverSALTSTACK-GPG-KEY.pub' >> $repofile
  yum clean all
}
